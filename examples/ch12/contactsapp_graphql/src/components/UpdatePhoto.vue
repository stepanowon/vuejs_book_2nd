...
<div class="modal">
    <div class="form" @keyup.esc="cancelEvent">
        ...
        <input type="hidden" name="_id" class="long" disabled v-model="contact._id" />
        <div>
            <label>현재 사진</label>
...
export default {
    ...
    mounted : function() {
        this.$store.dispatch(Constant.FETCH_CONTACT_ONE, { _id: this._id });
    },
    methods : {
        ...
        photoSubmit : function() {
            ...
            this.$store.dispatch(Constant.UPDATE_PHOTO, { _id:this.contact._id, file:file });
            this.$router.push({ name:'contacts', query: { page: this.contactlist.pageno }});
        }
    }
}
